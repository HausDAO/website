    ...
    <section className="bg-black text-green">
      ...
      <div className="py-12 md:container md:mx-auto">
        <div className="text-center">
          <h2 className="text-4xl uppercase text-white lg:text-6xl">
            Ecosystem
            <br />
            of apps
          </h2>
          <h3 className="my-4 font-sans text-xl font-extrabold uppercase text-white lg:text-3xl">
            Using the DAOHaus SDK
          </h3>
          <p className="mx-auto mb-24 max-w-sm text-xl text-white">
          ...
          <div className="my-12 text-left md:columns-3">
            <Card>
              <h2 className="pt-24 text-3xl text-red">Summoner</h2>
              <p className="my-8 text-red">
                When you first put the specifics of your decentralized and autonomous governance on
                chain, you’ve summoned a DAO.
              </p>
              <Button className="border-red text-red">Open App</Button>
            </Card>
            <Card>
              <h2 className="pt-24 text-3xl text-green">Mission Control</h2>
              <p className="my-8 text-green">
                While challenging, anyone can bring together autonomous contributors for
                decentralized collaborations and governance.
              </p>
              <Button className="border-green text-green">Open App</Button>
            </Card>
            <Card>
              <h2 className="pt-24 text-3xl text-purple-500">Hub</h2>
              <p className="my-8 text-purple-500">
                Vote and make proposals for the DAOs that you're a member of. Check out new DAOs and
                DAOs you’ve been curious about.
              </p>
              <Button className="border-purple-500 text-purple-500">Open App</Button>
            </Card>
          </div>
        </div>
        <Card>
