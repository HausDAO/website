...
const Footer = () => {
  return (
    <footer className="bg-blue text-white dark:bg-blue">
      <div className="grid grid-cols-2 gap-8 px-6 py-8 text-white md:mx-auto md:max-w-6xl md:grid-cols-4">
        <div>
      ...
      <div className="bg-blue-600 dark:bg-blue-600 px-4 py-6 md:flex md:items-center md:justify-between">
        ...
        <div className="mt-4 flex space-x-6 sm:justify-center md:mt-0">
          <a href="/#" className="hover:text-gray-900 text-white dark:hover:text-white">
