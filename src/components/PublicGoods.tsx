...
import communityOwned from '/public/img/dh_communityowned.svg';
import publicGood from '/public/img/dh_publicgood.svg';

const PublicGoods = () => {
  return (
    <section className="py-48 text-red md:container md:mx-auto">
      ...
      <div>
        <Card>
          <div className="gap-16 md:columns-1 lg:columns-3">
            <div className="">
              <img src={openSource} width="120px" className="mx-auto" />
            ...
            <div className="sm:my-8">
              <img src={communityOwned} width="120px" className="mx-auto" />
            ...
            <div className="sm:my-8">
              <img src={publicGood} width="120px" className="mx-auto" />
